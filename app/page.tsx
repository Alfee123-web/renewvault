    ...
    <main className="relative flex min-h-screen flex-col overflow-x-hidden bg-[var(--bg)] text-[var(--text-primary)]">
      ...
      >
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
          {/* Card 1 */}
          <div className={`reveal-card delay-100 relative z-0 rounded-[18px] border border-[var(--border)] bg-[var(--surface-2)] p-6 transition-all duration-300 ease-out hover:z-20 hover:scale-110 hover:border-[var(--border-strong)] hover:bg-[var(--surface-3)] hover:shadow-2xl hover:shadow-black/40 ${isFeaturesVisible ? "is-visible" : ""}`}>
          ...
          {/* Card 2 */}
          <div className={`reveal-card delay-200 relative z-0 rounded-[18px] border border-[var(--border)] bg-[var(--surface-2)] p-6 transition-all duration-300 ease-out hover:z-20 hover:scale-110 hover:border-[var(--border-strong)] hover:bg-[var(--surface-3)] hover:shadow-2xl hover:shadow-black/40 ${isFeaturesVisible ? "is-visible" : ""}`}>
          ...
          {/* Card 3 */}
          <div className={`reveal-card delay-300 relative z-0 rounded-[18px] border border-[var(--border)] bg-[var(--surface-2)] p-6 transition-all duration-300 ease-out hover:z-20 hover:scale-110 hover:border-[var(--border-strong)] hover:bg-[var(--surface-3)] hover:shadow-2xl hover:shadow-black/40 ${isFeaturesVisible ? "is-visible" : ""}`}>
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--surface)] text-[var(--secondary-text)]">
